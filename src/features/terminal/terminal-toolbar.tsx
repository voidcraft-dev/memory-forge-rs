...
export function TerminalToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/20 bg-background px-5 py-2.5 md:px-6 text-muted-foreground">
          ...
          <>
            ...
            {(status === "exited" || status === "failed" || status === "running") && (
              <Button
                variant="ghost"
                size="sm"
                className="h-9 gap-1.5 rounded-lg border border-border/20 text-muted-foreground hover:bg-emerald-500/10 hover:text-emerald-400 hover:border-emerald-500/30"
                onClick={onRestart}
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-9 gap-1.5 rounded-lg border border-border/20 text-muted-foreground hover:bg-primary/10 hover:text-primary hover:border-primary/30"
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-9 gap-1.5 rounded-lg border border-border/20 text-muted-foreground hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/30"
              onClick={onClose}
